...
This analysis makes use of Tobler's function for calculating speed given a hill gradient. While this approach is rather old, it is still the best option when real world data is not available for re-parametrisation. Tobler’s hiking function for speed,
