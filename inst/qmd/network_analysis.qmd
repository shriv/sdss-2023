...
@fig-toblers-params shows two versions of the same functional form but with different coefficients. Brunsdon's form has coefficients fitted with Strava data @RPubsTobler39. 
